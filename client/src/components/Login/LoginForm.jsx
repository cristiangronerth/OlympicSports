...
function LoginForm() {
  ...
  return (
    ...
    <Img className="relative mr-20 imgLeft" src={leftLogin} alt="" height={500} width={500}/>
      ...
      <Img2 className="relative ml-20 imgRight" src={rightLogin} alt="" height={550} width={500}/>
    </Flex>
  )
}
